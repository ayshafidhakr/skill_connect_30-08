...
function StudentDashboardCounselAttnd() {
...
<div className="widget">
            <div className="mailWrapper startExamWrapper bookCounsellingWrapper  hauto bookPaymentCounsellingWrapperContent dashboardBookCounsellingWrapperContent"> 
              
              <div className="bookCounsellingWrapperContent">
                <div className='counsellingStartedTitle02 dasboardCounsellingStartedTitle02'>You have attended the counselling session</div>
...
export default StudentDashboardCounselAttnd;