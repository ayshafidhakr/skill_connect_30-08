          ...
          <div className="content hauto">
            <div className="mailWrapper startExamWrapper bookCounsellingWrapper  hauto bookPaymentCounsellingWrapperContent"> 
              ...
              <div className="bookCounsellingWrapperContent">
                ...
                <div className='counsellingStartedTitle02'>Your counselling request has been approved</div>
                ...
                <div id='1' className='joinCounselingWrap w-100'><img src={C1} alt="" />
                      ...
                      <div className="ssnet"></div>
                      
                    </div>
                <div className='prepareInstructions'>
                  <div className="title77"> Preparation Instructions: </div>
                  <span> Any materials or documents the user needs to bring to the session. </span>
                  <span> Any prerequisites or preparation needed before the session.</span>   
                  <div className="title77">Session Details:</div> 
                  <div>Scheduled Date and Time of the Session</div>
                  <div> Duration of the Session</div>
               </div>
                <div className='margin2 mt-40 buttonWrap'>
                <button className="btnChooseCounsellor">Join Counselling</button>
                <button className="btnChooseCounsellor">Reschedule</button>
                </div>                
              </div>
